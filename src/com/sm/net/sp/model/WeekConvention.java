...
public class WeekConvention {
	...
	public WeekConvention(JSONObject jsonObject, Language language, Settings settings, boolean forMeeting) {
	...
	public void updateOnlineWeekInfo(ObservableList<WeekConvention> list, Language language, Settings settings) {
