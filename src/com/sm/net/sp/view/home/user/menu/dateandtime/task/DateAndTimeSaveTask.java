...
public class DateAndTimeSaveTask implements TaskInterface {
	...
	public DateAndTimeSaveTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage, DateAndTime dateAndTime,
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.DATE_AND_TIME_INSERT(this.dateAndTime);
