...
public class TerritoryMapsDeleteTask implements TaskInterface {
	...
	public TerritoryMapsDeleteTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage, Territory view, int id) {
		super();
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.TERRITORY_MAPS_DELETE(this.id);
