...
public class ConfigPDFReplaceRemoveTask implements TaskInterface {
	...
	public ConfigPDFReplaceRemoveTask(UserMenuConfig view, AlertBuilder alertBuilder, Settings settings,
			Stage viewStage, PDFReplace pdfReplace) {
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.PDFREPLACE_REMOVE(this.pdfReplace);
