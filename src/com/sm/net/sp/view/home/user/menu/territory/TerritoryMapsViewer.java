...
public class TerritoryMapsViewer {
	...
	private TerritoryMap selectedTerritory;
...
//		this.listenerCheckFields = true;
	...
	private void initValue() {
		...
		if (this.selectedTerritory != null) {
			...
			this.territoryNameTextField.setText(this.selectedTerritory.getSpInf1());

			this.territoryMyMapsIDTextField.setText(this.selectedTerritory.getSpInf2());
			this.territoryViewerIDTextField.setText(this.selectedTerritory.getSpInf3());

			this.image1TextField.setText(this.selectedTerritory.getSpInf4());
			this.image1TitleTextField.setText(this.selectedTerritory.getSpInf5());
			this.image2TextField.setText(this.selectedTerritory.getSpInf6());
			this.image2TitleTextField.setText(this.selectedTerritory.getSpInf7());
			this.image3TextField.setText(this.selectedTerritory.getSpInf8());
			this.image3TitleTextField.setText(this.selectedTerritory.getSpInf9());
			this.image4TextField.setText(this.selectedTerritory.getSpInf10());
			this.image4TitleTextField.setText(this.selectedTerritory.getSpInf11());
			this.image5TextField.setText(this.selectedTerritory.getSpInf12());
			this.image5TitleTextField.setText(this.selectedTerritory.getSpInf13());

			this.doc1TextField.setText(this.selectedTerritory.getSpInf14());
			this.doc1TitleTextField.setText(this.selectedTerritory.getSpInf15());
			this.doc2TextField.setText(this.selectedTerritory.getSpInf16());
			this.doc2TitleTextField.setText(this.selectedTerritory.getSpInf17());
			this.doc3TextField.setText(this.selectedTerritory.getSpInf18());
			this.doc3TitleTextField.setText(this.selectedTerritory.getSpInf19());
			this.doc4TextField.setText(this.selectedTerritory.getSpInf20());
			this.doc4TitleTextField.setText(this.selectedTerritory.getSpInf21());
			this.doc5TextField.setText(this.selectedTerritory.getSpInf22());
			this.doc5TitleTextField.setText(this.selectedTerritory.getSpInf23());
		}
	}
	...
	private void setReadOnly() {
		...
		this.territoryNameTextField.setEditable(false);
		this.territoryMyMapsIDTextField.setEditable(false);
		this.territoryViewerIDTextField.setEditable(false);

		this.image1TitleTextField.setEditable(false);
		this.image1TextField.setEditable(false);
		this.image2TitleTextField.setEditable(false);
		this.image2TextField.setEditable(false);
		this.image3TitleTextField.setEditable(false);
		this.image3TextField.setEditable(false);
		this.image4TitleTextField.setEditable(false);
		this.image4TextField.setEditable(false);
		this.image5TitleTextField.setEditable(false);
		this.image5TextField.setEditable(false);

		this.doc1TitleTextField.setEditable(false);
		this.doc1TextField.setEditable(false);
		this.doc2TitleTextField.setEditable(false);
		this.doc2TextField.setEditable(false);
		this.doc3TitleTextField.setEditable(false);
		this.doc3TextField.setEditable(false);
		this.doc4TitleTextField.setEditable(false);
	...
	public TerritoryMap getSelectedTerritory() {
		return selectedTerritory;
	}

	public void setSelectedTerritory(TerritoryMap selectedTerritory) {
