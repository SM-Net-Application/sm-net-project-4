...
public class ConfigPDFReplaceLoadTask implements TaskInterface {
	...
	public ConfigPDFReplaceLoadTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage,
			UserMenuConfig view) {
		super();
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.PDFREPLACE_LOAD();
	...
	public void feedback(HashMap<String, Object> hashMap) {
		...
		if (response != null) {
			...
			if (status == 0) {
				...
				this.view.updatePDFReplaceList(pdfReplaceList);
