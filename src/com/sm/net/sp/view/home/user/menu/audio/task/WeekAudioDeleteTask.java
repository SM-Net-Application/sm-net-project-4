...
public class WeekAudioDeleteTask implements TaskInterface {
	...
	public WeekAudioDeleteTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage, Audio view, int id) {
		super();
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.AUDIO_DELETE(this.id);
