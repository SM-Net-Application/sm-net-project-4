...
import com.sm.net.sp.view.home.user.menu.territory.task.TerritoryMapsSaveTask;
...
public class TerritoryMapsEditor {
...
//	}
	...
	private void save() {
		...
		if (checkFields()) {
			...
			TerritoryMap territoryObj = TerritoryMap.newInstanceByView(this,
			...
			TaskManager.run(this.application.getAlertBuilder2(), this.ownerStage, waitMessage,
					new TerritoryMapsSaveTask(this.application.getAlertBuilder2(), this.settings, this.ownerStage,
	...
	private boolean checkFields() {
		...
		if (this.territoryNameTextField.getText().isEmpty()) {
			...
			this.application.getAlertBuilder2().error(this.ownerStage,
					this.language.getString("territorymapseditor.error.emptyname"));
