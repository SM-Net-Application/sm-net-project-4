...
public class ConfigPDFDestRemoveTask implements TaskInterface {
	...
	public ConfigPDFDestRemoveTask(UserMenuConfig view, AlertBuilder alertBuilder, Settings settings, Stage viewStage,
			PDFDest pdfDest) {
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.PDFDEST_REMOVE(this.pdfDest);
