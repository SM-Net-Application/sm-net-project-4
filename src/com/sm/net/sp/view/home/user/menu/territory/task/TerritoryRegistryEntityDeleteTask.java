...
public class TerritoryRegistryEntityDeleteTask implements TaskInterface {

	private AlertBuilder alertBuilder;
	private Settings settings;
	private Stage viewStage;
	private TerritoryRegistryViewer view;
	private int id;

	public TerritoryRegistryEntityDeleteTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage,
			TerritoryRegistryViewer view, int id) {
		super();
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.TERRITORYENTITY_DELETE(this.id);
	...
	public void feedback(HashMap<String, Object> hashMap) {
		...
		if (status == 0) {
			...
			this.view.getParentTabPane().getTabs().remove(this.view.getNewTab());
			this.view.getOwnerCtrl().updateTerritory();
