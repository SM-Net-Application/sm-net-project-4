...
public class PostDeleteTask implements TaskInterface {
...
//	}
	...
	public PostDeleteTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage, PostNews postNews, Post view) {
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.POST_DELETE(this.postNews);
	...
	public void feedback(HashMap<String, Object> hashMap) {
		...
		if (status == 0) {
			...
			this.view.updateDeletedPost(this.postNews);
