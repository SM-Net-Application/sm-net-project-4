...
public class WeekConventionSaveTask implements TaskInterface {

	private Convention view;
	private AlertBuilder alertBuilder;
	private Settings settings;
	private Stage viewStage;
	private WeekConvention weekConvention;
	private Tab thisTab;

	public WeekConventionSaveTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage,
			WeekConvention weekConvention, Convention view, Tab thisTab) {
		super();
		...
		this.weekConvention = weekConvention;
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		if (this.weekConvention.spConvenIDProperty() != null)
			json = JSONRequest.CONVENTION_UPDATE(this.weekConvention);
		else
			json = JSONRequest.CONVENTION_INSERT(this.weekConvention);
