...
//		this.image5TitleLabel.setText(String.format(imageTitleFormat, 5));
	...
	private void setReadOnly() {
		...
		this.territoryNumberTextField.setEditable(false);
		this.territoryNameTextField.setEditable(false);
		this.territoryCoordinatesTextField.setEditable(false);
		this.territoryLandTextField.setEditable(false);
		this.territoryLandkreisTextField.setEditable(false);
		this.territoryKreisstadtTextField.setEditable(false);
		this.territoryOrtTextField.setEditable(false);
		this.territoryZipCodeTextField.setEditable(false);
		this.territoryOrtsteilTextField.setEditable(false);
