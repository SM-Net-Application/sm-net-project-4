...
public class ConventionInitDataLoadTask implements TaskInterface {
	...
	public ConventionInitDataLoadTask(AlertBuilder alertBuilder, Settings settings, Stage stage, Convention view) {
		super();
