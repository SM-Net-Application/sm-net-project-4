...
public class GeneralInfoLoadTask implements TaskInterface {

	private UserMenuGeneralInfo view;
	private AlertBuilder alertBuilder;
	private Settings settings;
	private Stage viewStage;

	public GeneralInfoLoadTask(AlertBuilder alertBuilder, Settings settings, Stage viewStage,
			UserMenuGeneralInfo view) {
		super();
	...
	public void start(HashMap<String, Object> hashMap) {
		...
		JSONObject json = JSONRequest.GENERAL_INFO_LOAD();
	...
	public void feedback(HashMap<String, Object> hashMap) {
		...
		this.view.setGeneralInfos(generalInfos);
		this.view.fill();
	}
}
