            ...
            if (!$database) {
                ...
                foreach ($weeks as $week) {
                    ...
                    if ($memberID == $week["spInf3"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_president'], $language['midweek_president_icon']));
                    }
                    if ($memberID == $week["spInf4"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_pray1'], $language['midweek_pray1_icon']));
                    }
                    if ($memberID == $week["spInf11"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_talk'], $language['midweek_talk_icon']));
                    }
                    if ($memberID == $week["spInf14"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_digging'], $language['midweek_digging_icon']));
                    }
                    if ($memberID == $week["spInf18"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_biblereading1'], $language['midweek_biblereading1_icon']));
                    }
                    if ($memberID == $week["spInf28"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_biblereading2'], $language['midweek_biblereading1_icon']));
                    }
                    if ($memberID == $week["spInf23"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_congrbiblestudy'], $language['midweek_congrbiblestudy_icon']));
                    }
                    if ($memberID == $week["spInf29"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_congrbiblestudyreader'], $language['midweek_congrbiblestudyreader_icon']));
                    }
                    if ($memberID == $week["spInf27"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_pray2'], $language['midweek_pray2_icon']));
                    }

                    // INCARICHI ADUNANZA DEL FINE SETTIMANA
                    if ($memberID == $week["spInf30"]) {
                        if ($week["spInf41"] == 1) {
                            array_push($activities, newTask($weekend, $weekend_text, $language['weekend_pray1'], $language['weekend_pray1_icon']));
                        } else {
                            array_push($activities, newTask($weekend, $weekend_text, $language['weekend_president'], $language['weekend_president_icon']));
                        }
                    }
                    if ($memberID == $week["spInf37"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_watchtower'], $language['weekend_watchtower_icon']));
                    }
                    if ($memberID == $week["spInf38"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_watchtowerreader'], $language['weekend_watchtowerreader_icon']));
                    }
                    if ($memberID == $week["spInf40"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_pray2'], $language['weekend_pray2_icon']));
                    }
                }
                // ***********************************
                ...
                foreach ($ministry as $min) {
                    ...
                    if ($memberID == $min["spInf7"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_ministrystudent1'], $language['midweek_ministrystudent1_icon']));
                    }
                    if ($memberID == $min["spInf8"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_ministryassistant1'], $language['midweek_ministryassistant1_icon']));
                    }
                    if ($memberID == $min["spInf9"]) {
                        if ($min["spInf3"] == 1) {
                            array_push($activities, newTask($midweek, $midweek_text, $language['midweek_ministrypresident'], $language['midweek_ministrypresident_icon']));
                        } else {
                            array_push($activities, newTask($midweek, $midweek_text, $language['midweek_ministrystudent2'], $language['midweek_ministrystudent2_icon']));
                        }
                    }
                    if ($memberID == $min["spInf10"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_ministryassistant2'], $language['midweek_ministryassistant2_icon']));
                    }
                }
                ...
                foreach ($christians as $christian) {
                    ...
                    if ($memberID == $christian["spInf6"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_christianlife'], $language['midweek_christianlife_icon']));
                    }
                }
                ...
                foreach ($audio as $aud) {
                    ...
                    if ($memberID == $aud["spInf2"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_audio1'], $language['midweek_audio1_icon']));
                    }
                    if ($memberID == $aud["spInf3"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_audio2'], $language['midweek_audio2_icon']));
                    }
                    if ($memberID == $aud["spInf4"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_audio3'], $language['midweek_audio3_icon']));
                    }
                    if ($memberID == $aud["spInf5"]) {
                        array_push($activities, newTask($midweek, $midweek_text, $language['midweek_audiomic'], $language['midweek_audiomic_icon']));
                    }
                    ...
                    if ($memberID == $aud["spInf8"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_audio1'], $language['weekend_audio1_icon']));
                    }
                    if ($memberID == $aud["spInf9"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_audio2'], $language['weekend_audio2_icon']));
                    }
                    if ($memberID == $aud["spInf10"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_audio3'], $language['weekend_audio3_icon']));
                    }
                    if ($memberID == $aud["spInf11"]) {
                        array_push($activities, newTask($weekend, $weekend_text, $language['weekend_audiomic'], $language['weekend_audiomic_icon']));
                    }
...
function newTask($date, $date_text, $activity_name, $activity_icon)
{
