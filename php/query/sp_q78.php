...
// Get all weeks
		...
		if (! $database) {
			...
			$query = "SELECT spWeekID, spInf1, spInf2, spInf3, spInf4,";
			$query .= " spInf5, spInf6, spInf7, spInf8, spInf9, spInf10,";
			$query .= " spInf11, spInf12, spInf13, spInf14, spInf15, spInf16,";
			$query .= " spInf17, spInf18, spInf19, spInf20, spInf21, spInf22,";
			$query .= " spInf23, spInf24, spInf25, spInf26, spInf27, spInf28,";
            $query .= " spInf29, spInf30, spInf31, spInf32, spInf33, spInf34,";
            $query .= " spInf35, spInf36, spInf37, spInf38, spInf39, spInf40,";
            $query .= " spInf41, spInf42, spInf43, spInf44, spInf45, spInf46,";
			$query .= " spInf47, spInf48, spInf49, spInf50, spInf51, spInf52, spInf53,";
			$query .= " spInf54, spInf55, spInf56, spInf57, spInf58,";
			$query .= " spInf59, spInf60, spInf61, spInf62,";
			$query .= " spInf63, spInf64, spInf65, spInf66";
			$query .= " FROM sp_week";
