...
if (isset ( $jsonObj ["user"] ) && isset ( $jsonObj ["password"] )) {
    if (! empty ( $jsonObj ["user"] ) && ! empty ( $jsonObj ["password"] )) {
        ...
        if (! $database) {
            ...
            $query = "SELECT spUserID, spUserSU, spUserName, spUserPassword, spInf1, spInf2, spInf3, spInf4, spInf5, spInf6, spInf7, spInf8, spInf9, spInf10, spInf11, spInf12, spInf13, spInf14, spInf15, spInf16, spInf17, spInf18, spInf19, spInf20 FROM sp_users WHERE";
            $query .= " ";
